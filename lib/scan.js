...
//     return acc;
//   }, new Set());
//   for (const version of new Set([...keys].map(v => v.replace(/-alpha.\d+/, '')))) {
//     const notes = items
...
//     await spawnSync("md-to-pdf", ['notes/*.md', "--highlight-style monokai"], { shell: true, stdio: "inherit", windowsHide: true });
//     await spawnSync("md-to-pdf", ['notes/*.md', '--as-html', "--highlight-style monokai"], { shell: true, stdio: "inherit", windowsHide: true });
